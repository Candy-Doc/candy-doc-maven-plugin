...
class BoundedContextDtoMapperTest {
    ...
    @Test
    void returning_interaction_are_generated() {
        //given
        eventList.addAll(List.of(CoreConceptFound.builder()
                        .name("core concept")
                        .description("core concept description")
                        .className("candydoc.sample.bounded_context_for_core_concepts_tests.CoreConcept1")
                        .packageName("candydoc.sample.bounded_context_for_core_concepts_tests")
                ...
                ValueObjectFound.builder()
                        ...
                        .packageName("candydoc.sample.bounded_context_for_core_concepts_tests")
                        .className("candydoc.sample.bounded_context_for_core_concepts_tests.test")
                        .boundedContext("bounded.context")
                        .build(),
                InteractionBetweenConceptFound.builder()
                        .from("candydoc.sample.bounded_context_for_core_concepts_tests.CoreConcept1")
                        .with("candydoc.sample.bounded_context_for_core_concepts_tests.test")
                        .build()
        ));
        //when
        List<BoundedContextDto> boundedContextDtos = BoundedContextDtoMapper.map(eventList);
        //then
       Assertions.assertThat(boundedContextDtos).contains(BoundedContextDto.builder()
               .name("bounded context")
               .description("description")
               .packageName("bounded.context")
               .concepts(List.of(ConceptDto.builder()
                       .name("core concept")
                       .description("core concept description")
                       .className("candydoc.sample.bounded_context_for_core_concepts_tests.CoreConcept1")
                       .type(ConceptType.CORE_CONCEPT)
